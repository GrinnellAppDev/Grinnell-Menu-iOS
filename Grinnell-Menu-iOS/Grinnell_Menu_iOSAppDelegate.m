...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        ...
        self.datePickerViewController.stationsViewController =  [[StationsViewController alloc] init];
        ...
        [self.navigationController pushViewController:self.datePickerViewController.stationsViewController   animated:NO];
